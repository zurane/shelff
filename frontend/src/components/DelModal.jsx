        ...
        <div>
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-10 py-1 rounded-full"
            >
              Delete
            </button>
            <button
              onClick={props.cancel}
              className="bg-gray-500 hover:bg-gray-600 text-white px-10 py-1 rounded-full"
            >
              Cancel
            </button>
          </div>
...
DelModal.propTypes = {
  // Define the props that the component will receive from its parent.
