      ...
      <div className=" bg-slate-100  rounded p-7 flex items-center justify-center">
        <div>
          ...
          <div className="flex gap-2 mt-4">
            <button className="bg-red-500 hover:bg-red-600 text-white px-10 py-1 rounded-full">
              Delete
            </button>
            <button className="bg-gray-500 hover:bg-gray-600 text-white px-10 py-1 rounded-full">
              Cancel
            </button>
          </div>
        </div>
